        ...
        <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="relative shadow-xl sm:overflow-hidden sm:rounded-2xl">
            ...
            <div className="lg:pb-18 relative px-12 pt-16 pb-8 sm:px-12 sm:pt-24 sm:pb-14 lg:px-16 lg:pt-32">
              ...
              <p className="mx-auto -mt-4 max-w-lg text-center text-xl text-black sm:max-w-3xl font-montserrat">
              ...
              <ul className="list-disc list-inside mx-auto mt-4 max-w-lg text-center text-xl text-black sm:max-w-3xl font-montserrat">
